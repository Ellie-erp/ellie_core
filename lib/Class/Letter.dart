...
class Letter {
 ...
 Letter({this.docRef,required  this.createDate,required   this.letterDate, this.letterTitle='', this.recipient='',required this.content,required this.complimentaryClose,});
